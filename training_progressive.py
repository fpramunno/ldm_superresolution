# -*- coding: utf-8 -*-
"""
Created on Mon Nov 11 15:41:47 2024
...
from model_enhance import ProgressiveSR
...
bicubic_512 = transforms.Resize((512, 512), interpolation=InterpolationMode.BICUBIC)
bicubic_1024 = transforms.Resize((1024, 1024), interpolation=InterpolationMode.BICUBIC)
model = ProgressiveSR(bicubic_512, bicubic_1024, c_in=1, c_out=1, channel_mult=8).to(device)
...
for epoch in range(args.epochs):
    ...
    for i, (image_94, label, time, cdelt1, cdelt2, crpix1, crpix2, rsun_obs, mindata) in enumerate(pbar):
        ...
        with autocast():
            predicted_noise = model(down_24) # model(x_t, None, labels, t, clip_emb_up_24)
